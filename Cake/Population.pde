void population() {
  ...
  buttonIIY = appHeight * 2/18;
  buttonIIW = appWidth * 1/7;
  buttonIIH = appHeight * 1/6;
  //
  buttonIX = appWidth * 6/8;
  buttonIY = appHeight * 3/18;
  buttonIW = appWidth * 1/7;
  buttonIH = appHeight * 1/6;
  //
  ...
  //
  smollButtonIX =appWidth * 4/6;
  smollButtonIY = appHeight * 13/18;
  smollButtonIW = appWidth * 1/13;
  smollButtonIH = appHeight * 1/13;
  //
  smollButtonIIX =appWidth * 5/6;
  smollButtonIIY = appHeight * 13/18;
  smollButtonIIW = appWidth * 1/13;
  smollButtonIIH = appHeight * 1/13;
  //
  smollButtonIIIX =appWidth * 1/8;
  smollButtonIIIY = appHeight * 12/18;
  smollButtonIIIW = appWidth * 1/13;
  smollButtonIIIH = appHeight * 1/13;
  //
  smollButtonIVX = appWidth * 2/6;
  smollButtonIVY = appHeight * 16/18;
  smollButtonIVW = appWidth * 1/13;
  smollButtonIVH = appHeight * 1/13;
  //  
  smollButtonVX = appWidth * 4/8;
  smollButtonVY = appHeight * 1/12;
  smollButtonVW = appWidth * 1/13;
  smollButtonVH = appHeight * 1/13;
  //
  wideButtonIX = appWidth * 3/7; 
  wideButtonIY = appHeight * 282/802;  
  wideButtonIW = appWidth * 1/7;  
  wideButtonIH = appHeight * 1/13; 
  //
  wideButtonIIX = appWidth * 3/7;  
  wideButtonIIY = appHeight * 463/802;  
  wideButtonIIW = appWidth * 1/7;  
  wideButtonIIH = appHeight * 1/13 ; 
  //
  tallButtonIX = appWidth * 513/900;  
  tallButtonIY = appHeight * 3/7;  
  tallButtonIW = appWidth * 1/13;  
  tallButtonIH = appHeight * 15/100; 
  //
  tallButtonIIX = appWidth * 316/900;  
